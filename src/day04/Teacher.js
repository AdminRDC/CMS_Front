...
import WrappedHorizontalLoginForm from '../day05/HorizontalLoginForm';
    ...
    render(){
        ...
        return (
            <div className='student'>
                ...
                {/* antd表格 */}
                <Table  rowKey={record => record.id} bordered={true} rowSelection={rowSelection} columns={columns} dataSource={teachers} />
            </div>
        )
    }
}
